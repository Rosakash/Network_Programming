...
class request_performer():
    def __init__( self):
        ...
        self.l1=Label(self.tops,font=('arial',40,'bold'),text="Sql Injection")
        ...
        self.b1=Button(self.f5,font=('arial',15,'bold'),text="Launch",command=self.run,cursor="pirate")   
    ...
    def run(self):
        f=open('injections.txt', mode='r')
        for line in f:
            word=line
            
            url =("http://www."+self.e1.get()+".com/news.php?id=")
